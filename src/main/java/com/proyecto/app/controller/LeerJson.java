...
public class LeerJson {
    public static void leerJsonClientes() {
        File j = new File("D:\\proyectoProgramacion\\src\\main\\java\\com\\proyecto\\app\\ficheros\\clientes.json");
        Scanner sc = null;
        String datosJson;
        try {
    ...
    public static void leerJsonProductos() {
        File j = new File("D:\\proyectoProgramacion\\src\\main\\java\\com\\proyecto\\app\\ficheros\\productos.json");
        Scanner sc = null;
        String datosJson;
        try {
            sc = new Scanner(j).useDelimiter("}");
    ...
    public static void leerJsonProveedores() {
        File j = new File("D:\\proyectoProgramacion\\src\\main\\java\\com\\proyecto\\app\\ficheros\\proovedores.json");
        Scanner sc=null;
        String datosJson;
        try {
            sc=new Scanner(j).useDelimiter("}");
